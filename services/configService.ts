...
const loadConfig = (): AppConfig => {
  ...
  // FIX: Safely access `env` by providing a fallback empty object. This prevents
  // the application from crashing if Vite's environment variables are not injected,
  // allowing it to proceed with default model configurations.
